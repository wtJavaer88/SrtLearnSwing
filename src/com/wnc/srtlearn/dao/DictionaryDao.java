...
public class DictionaryDao {
	...
	static {
		...
		Map selectAllSqlMap = DbExecMgr.getSelectAllSqlMap("select * from topic_resource res,dictionary dict,books"
	...
	private static List<Topic> getExchangeTopics(Map rowMap) {
		String[] exchanges = { "WORD_DONE", "WORD_ER", "WORD_EST", "WORD_ING", "WORD_PAST", "WORD_PL", "WORD_THIRD" };
	...
	public static boolean insertExchange(String topic_id, WordExchange wordExchange) throws SQLException {
